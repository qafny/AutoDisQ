...
(* MAIN.ml  — test harness / pretty-printers for AutoDisQ extraction *)
...
(* ===================================================== *)
(* Alg3 debug printers: SCC blocks + flattened schedule   *)
(* ===================================================== *)
...
let show_alg3_flat (pname:string) (ops:op_list) : unit =
  ...
  let hp : hb_relation = gen_hp ops in
  let procs : process list = auto_parallelize_alg3 myOp_eqb ops hp seq0 in
  List.iter (fun pr -> Printf.printf "  %s\n%!" (pp_process pr)) procs

(* ===================================================== *)
(* Alg3-Layers debug printers                              *)
(* ===================================================== *)
...
let show_alg3_layers_flat (pname:string) (ops:op_list) : unit =
  ...
  let hp : hb_relation = gen_hp ops in
  let procs : process list = auto_parallelize_alg3_layers myOp_eqb ops hp seq0 in
  List.iter (fun pr -> Printf.printf "  %s\n%!" (pp_process pr)) procs
...
let () =
  ...
  (* If your extraction provides shor_Qprog_64 (lowercase), keep this.
     If it provides Shor_Qprog_64 (uppercase), change the name here. *)
  ...
  show_alg3_blocks "P_1" p_1;  show_alg3_flat "P_1" p_1;
  show_alg3_blocks "P_3" p_3;  show_alg3_flat "P_3" p_3;
  show_alg3_blocks "P_4" p_4;  show_alg3_flat "P_4" p_4;
  show_alg3_blocks "P_5 (Grover)" p_5;  show_alg3_flat "P_5 (Grover)" p_5;
  show_alg3_blocks "P_6 (Teleport)" p_6; show_alg3_flat "P_6 (Teleport)" p_6;
  show_alg3_blocks "Shor_Qprog" shor_Qprog; show_alg3_flat "Shor_Qprog" shor_Qprog;
  show_alg3_blocks "Shor_Qprog_64" shor_Qprog_64; show_alg3_flat "Shor_Qprog_64" shor_Qprog_64;

  (* -------- Algorithm 3-Layers: partitions -------- *)
  show_alg3_layers_blocks "P_1" p_1;  show_alg3_layers_flat "P_1" p_1;
  show_alg3_layers_blocks "P_3" p_3;  show_alg3_layers_flat "P_3" p_3;
  show_alg3_layers_blocks "P_4" p_4;  show_alg3_layers_flat "P_4" p_4;
  show_alg3_layers_blocks "P_5 (Grover)" p_5;  show_alg3_layers_flat "P_5 (Grover)" p_5;
  show_alg3_layers_blocks "P_6 (Teleport)" p_6; show_alg3_layers_flat "P_6 (Teleport)" p_6;
  show_alg3_layers_blocks "Shor_Qprog" shor_Qprog; show_alg3_layers_flat "Shor_Qprog" shor_Qprog;
  show_alg3_layers_blocks "Shor_Qprog_64" shor_Qprog_64; show_alg3_layers_flat "Shor_Qprog_64" shor_Qprog_64
...
(* ---------- Shared compiler settings (define BEFORE use) ---------- *)
