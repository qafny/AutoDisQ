...
let count_send_in_memb (Memb (_, p)) =
  count_send_in_process p
...
let bench_best prog mids =
  protect_bench (fun () -> autodisq_best prog mids)
...
let () =
  ...
  run_best   "autodisq_best SHOR16_prog [0]" shor16_prog [0];
  ...
  summary_header ();
  summary_row "small_prog1" (bench_best small_prog1 mids_small);
  summary_row "small_prog2" (bench_best small_prog2 mids_small);
  summary_row "GHZ8" (bench_best ghz8_prog [0;1]);
  summary_row "GHZ16" (bench_best ghz16_prog [0;1]);
  summary_row "SHOR8" (bench_best shor8_prog [0;1]);
  summary_row "SHOR16[0;1]" (bench_best shor16_prog [0;1]);
  summary_row "SHOR16[0]" (bench_best shor16_prog [0]);
  summary_row "QFT8" (bench_best qft8_prog [0;1]);
  summary_row "QFT16" (bench_best qft16_prog [0;1]);
  summary_row "QFTAdder8" (bench_best qftAdder8_prog [0;1]);
  summary_row "QFTAdder16" (bench_best qftAdder16_prog [0;1]);
  summary_row "QFT32" (bench_best qft32_prog [0;1]);
  summary_row "QFTAdder32" (bench_best qftAdder32_prog [0;1])
