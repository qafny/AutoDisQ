...
let () =
  ...
  report_unit "gen_mem GHZ256 [0;1;2;3;4]"
    (protect_unit (fun () -> test_gen_mem ghz256_prog mids_5));

  report_unit "gen_prog GHZ256 [0;1;2;3;4]"
    (protect_unit (fun () -> test_gen_prog ghz256_prog mids_5));

  test_num_mem_configs ghz256_prog mids_5;
  test_num_final_configs ghz256_prog mids_5;

  report_best "autodisq_best_1 GHZ256 [0;1;2;3;4]"
    (protect_bench (fun () -> autodisq_best_1 ghz256_prog mids_5));
  ...
  report_unit "gen_mem SHOR256 [0;1;2;3;4]"
    (protect_unit (fun () -> test_gen_mem shor256_prog mids_5));

  report_unit "gen_prog SHOR256 [0;1;2;3;4]"
    (protect_unit (fun () -> test_gen_prog shor256_prog mids_5));

  report_best "autodisq_best_1 SHOR256 [0;1;2;3;4]"
    (protect_bench (fun () -> autodisq_best_1 shor256_prog mids_5));
  ...
  report_unit "gen_mem RippleCarry256 [0;1;2;3;4]"
    (protect_unit (fun () -> test_gen_mem rippleCarry256 mids_5));

  report_unit "gen_prog RippleCarry256 [0;1;2;3;4]"
    (protect_unit (fun () -> test_gen_prog rippleCarry256 mids_5));

  report_best "autodisq_best_1 RippleCarry256 [0;1;2;3;4]"
    (protect_bench (fun () -> autodisq_best_1 rippleCarry256 mids_5));
  ...
  report_unit "gen_mem QFTAdder256 [0;1;2;3;4]"
    (protect_unit (fun () -> test_gen_mem qftAdder256 mids_5));

  report_unit "gen_prog QFTAdder256 [0;1;2;3;4]"
    (protect_unit (fun () -> test_gen_prog qftAdder256 mids_5));

  report_best "autodisq_best_1 QFTAdder256 [0;1;2;3;4]"
    (protect_bench (fun () -> autodisq_best_1 qftAdder256 mids_5));
  ...
  report_unit "gen_mem AmpEst256 [0;1;2;3;4]"
    (protect_unit (fun () -> test_gen_mem ampEst256Seq mids_5));

  report_unit "gen_prog AmpEst256 [0;1;2;3;4]"
    (protect_unit (fun () -> test_gen_prog ampEst256Seq mids_5));

  report_best "autodisq_best_1 AmpEst256 [0;1;2;3;4]"
    (protect_bench (fun () -> autodisq_best_1 ampEst256Seq mids_5));
